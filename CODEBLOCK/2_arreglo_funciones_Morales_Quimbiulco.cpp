...
void inicializar_arreglopuntero(float arreglo[],int tam,int valor);
void mostrar_arreglo(float arreglo[],int tam);
void mostrar_arreglo_puntero(float *parreglo[],int tam);
...
int generar_aleatorio(float linf, float lsup);
...
void ordenar_burbuja(float arreglo[],int tam);
void ordenar_puntero(float *parr, int tam);
void bubble_sort(float vector[]);
...
int main(){
    ...
    cout<<"[6] Ordenar menotodo de burbuja "<<endl;
    cout<<"[7] Salir"<<endl;
    cin>>digito;
    switch(digito){
        case 1:
        ...
        case 6:
            ...
            //llenar_datos(notas, TAM,0,100);
            mostrar_arreglo(notas,TAM);
            ordenar_burbuja(notas,TAM);
            mostrar_arreglo(notas,TAM);
            break;
        case 8:
            inicializar_arreglopuntero(notas,TAM,1);
            ingresar_datos(notas,TAM);
            //llenar_datos(notas, TAM,0,100);
            ordenar_puntero(notas ,TAM);
            //mostrar_arreglo_puntero(notas ,TAM);
            break;
        case 9:
...
/*
void inicializar_arreglopuntero(float *parr[],int tam,int valor){
    for(int i=0;i<tam;i++){
        *(parr+i)=valor;
...
void mostrar_arreglo_puntero(float *parr[],int tam){
    for(int i =0;i<tam;i++){
        cout<<" [";
        cout<<*(parr+i )<<endl;
        cout<<"]  ";
...
void ingresar_datos(float arreglo[],int tam){
    for( int i=0;i<tam;i++){
            ...
            if (arreglo[i]>20||arreglo[i]<=0){
                cout<<"Solo permite valores 0 al 20"<<endl;
            }
